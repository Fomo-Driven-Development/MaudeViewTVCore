...
func registerMiscHandlers(api huma.API, svc MultiService) {
	...
	huma.Register(api, huma.Operation{OperationID: "multi-scan-backtesting-access", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/strategy/scan", Summary: "Scan for backtesting strategy API location", Tags: []string{"Strategy"}},
