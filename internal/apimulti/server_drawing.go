...
func registerDrawingHandlers(api huma.API, svc MultiService) {
	type shapeGroupsOutput struct {
		Body struct {
			Groups []cdpcontrol.ShapeGroup `json:"groups"`
		}
	}
	huma.Register(api, huma.Operation{OperationID: "multi-list-drawing-shapes", Method: http.MethodGet, Path: "/api/v1/drawings/shapes", Summary: "List known drawing shapes grouped by category", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-list-drawings", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/drawings", Summary: "List all drawings on chart", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-get-drawing", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/drawings/{shape_id}", Summary: "Get drawing by ID", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-create-drawing", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/drawings", Summary: "Create a single-point drawing", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-create-multipoint-drawing", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/drawings/multipoint", Summary: "Create a multi-point drawing", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-create-tweet-drawing", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/drawings/tweet", Summary: "Create a tweet drawing from a URL", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-clone-drawing", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/drawings/{shape_id}/clone", Summary: "Clone a drawing", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-remove-drawing", Method: http.MethodDelete, Path: "/api/v1/chart/{chart_id}/drawings/{shape_id}", Summary: "Remove a drawing", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-remove-all-drawings", Method: http.MethodDelete, Path: "/api/v1/chart/{chart_id}/drawings", Summary: "Remove all drawings", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-get-drawing-toggles", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/drawings/toggles", Summary: "Get drawing toggle states", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-set-hide-drawings", Method: http.MethodPut, Path: "/api/v1/chart/{chart_id}/drawings/toggles/hide", Summary: "Hide or show all drawings", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-set-lock-drawings", Method: http.MethodPut, Path: "/api/v1/chart/{chart_id}/drawings/toggles/lock", Summary: "Lock or unlock all drawings", Tags: []string{"Drawings"}},
		func(ctx context.Context, input *struct {
			ChartID string `path:"chart_id"`
			Body    struct {
				Value bool `json:"value"`
	...
	huma.Register(api, huma.Operation{OperationID: "multi-set-magnet", Method: http.MethodPut, Path: "/api/v1/chart/{chart_id}/drawings/toggles/magnet", Summary: "Set magnet mode", Tags: []string{"Drawings"}},
		func(ctx context.Context, input *struct {
			ChartID string `path:"chart_id"`
			Body    struct {
	...
	huma.Register(api, huma.Operation{OperationID: "multi-set-drawing-visibility", Method: http.MethodPut, Path: "/api/v1/chart/{chart_id}/drawings/{shape_id}/visibility", Summary: "Set drawing visibility", Tags: []string{"Drawings"}},
		func(ctx context.Context, input *struct {
			ChartID string `path:"chart_id"`
			ShapeID string `path:"shape_id"`
			Body    struct {
	...
	huma.Register(api, huma.Operation{OperationID: "multi-get-drawing-tool", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/drawings/tool", Summary: "Get selected drawing tool", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-set-drawing-tool", Method: http.MethodPut, Path: "/api/v1/chart/{chart_id}/drawings/tool", Summary: "Set drawing tool", Tags: []string{"Drawings"}},
		func(ctx context.Context, input *struct {
			ChartID string `path:"chart_id"`
			Body    struct {
	...
	for _, tool := range []struct {
		...
		{"multi-activate-measure-tool", "measure", "measure", "Activate measure tool"},
		{"multi-activate-zoom-tool", "zoom", "zoom", "Activate zoom-in selection tool"},
		{"multi-activate-eraser-tool", "eraser", "eraser", "Activate eraser tool"},
		{"multi-activate-cursor-tool", "cursor", "cursor", "Return to default cursor"},
	} {
	...
	huma.Register(api, huma.Operation{OperationID: "multi-set-drawing-z-order", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/drawings/{shape_id}/z-order", Summary: "Change drawing z-order", Tags: []string{"Drawings"}},
		func(ctx context.Context, input *struct {
			ChartID string `path:"chart_id"`
			ShapeID string `path:"shape_id"`
			Body    struct {
	...
	huma.Register(api, huma.Operation{OperationID: "multi-export-drawings-state", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/drawings/state", Summary: "Export all drawings state", Tags: []string{"Drawings"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-import-drawings-state", Method: http.MethodPut, Path: "/api/v1/chart/{chart_id}/drawings/state", Summary: "Import drawings state", Tags: []string{"Drawings"}},
		func(ctx context.Context, input *struct {
			ChartID string `path:"chart_id"`
			Body    struct {
