...
func registerStudyHandlers(api huma.API, svc MultiService) {
	...
	huma.Register(api, huma.Operation{OperationID: "multi-list-studies", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/studies", Summary: "List studies", Tags: []string{"Studies"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-add-study", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/studies", Summary: "Add study", Tags: []string{"Studies"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-remove-study", Method: http.MethodDelete, Path: "/api/v1/chart/{chart_id}/studies/{study_id}", Summary: "Remove study", Tags: []string{"Studies"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-get-study", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/studies/{study_id}", Summary: "Get study detail with inputs", Tags: []string{"Studies"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-modify-study", Method: http.MethodPatch, Path: "/api/v1/chart/{chart_id}/studies/{study_id}", Summary: "Modify study input parameters", Tags: []string{"Studies"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-add-compare", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/compare", Summary: "Add compare/overlay symbol", Tags: []string{"Compare"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-list-compares", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/compare", Summary: "List compare/overlay studies", Tags: []string{"Compare"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-remove-compare", Method: http.MethodDelete, Path: "/api/v1/chart/{chart_id}/compare/{study_id}", Summary: "Remove compare/overlay study", Tags: []string{"Compare"}},
	...
	// --- Study Template endpoints (moved under /chart/{chart_id}/) ---

	type studyTemplateListOutput struct {
		Body cdpcontrol.StudyTemplateList
	}
	huma.Register(api, huma.Operation{OperationID: "multi-list-study-templates", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/study-templates", Summary: "List all study templates", Tags: []string{"Studies"}},
		func(ctx context.Context, input *chartIDInput) (*studyTemplateListOutput, error) {
			list, err := svc.ListStudyTemplates(ctx, input.ChartID)
			if err != nil {
				return nil, mapErr(err)
			}
	...
	huma.Register(api, huma.Operation{OperationID: "multi-get-study-template", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/study-templates/{template_id}", Summary: "Get study template detail", Tags: []string{"Studies"}},
		func(ctx context.Context, input *struct {
			ChartID    string `path:"chart_id"`
			TemplateID int    `path:"template_id"`
		}) (*studyTemplateOutput, error) {
			entry, err := svc.GetStudyTemplate(ctx, input.ChartID, input.TemplateID)
			if err != nil {
				return nil, mapErr(err)
			}
	...
	huma.Register(api, huma.Operation{OperationID: "multi-apply-study-template", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/study-templates/apply", Summary: "Apply a study template by name", Tags: []string{"Studies"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-search-indicators", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/indicators/search", Summary: "Search indicators by query", Tags: []string{"Indicators"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-add-indicator", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/indicators/add", Summary: "Search and add indicator by clicking Nth result", Tags: []string{"Indicators"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-list-favorite-indicators", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/indicators/favorites", Summary: "List favorite indicators", Tags: []string{"Indicators"}},
	...
	huma.Register(api, huma.Operation{OperationID: "multi-toggle-indicator-favorite", Method: http.MethodPost, Path: "/api/v1/chart/{chart_id}/indicators/favorite", Summary: "Toggle favorite on a search result", Tags: []string{"Indicators"}},
	...
	// probe-dom moved under /chart/{chart_id}/ so agents can target a specific window
	type probeIndicatorDOMOutput struct {
		Body map[string]any
	}
	huma.Register(api, huma.Operation{OperationID: "multi-probe-indicator-dom", Method: http.MethodGet, Path: "/api/v1/chart/{chart_id}/indicators/probe-dom", Summary: "Probe indicator dialog DOM structure (debug)", Tags: []string{"Indicators"}},
		func(ctx context.Context, input *chartIDInput) (*probeIndicatorDOMOutput, error) {
			result, err := svc.ProbeIndicatorDialogDOM(ctx, input.ChartID)
			if err != nil {
				return nil, mapErr(err)
			}
